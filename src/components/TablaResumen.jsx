...
const TablaResumen = () => {
  ...
  return (
    <>
      <table className="tabla-container tabla-resumen" id='tabla-resumen'>
        <thead>
          <tr>
      ...
      <button type="button" style={{display: 'block', position: 'fixed', top: '87%'}} className="formulario__btn descarga" onClick={() => tableToExcel('tabla-resumen', 'Presupuesto del Mes')}>Descargar</button>
    </>
  )
};
